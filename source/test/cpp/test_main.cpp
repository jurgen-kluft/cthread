...
UNITTEST_SUITE_DECLARE(cUnitTest, xevent);
UNITTEST_SUITE_DECLARE(cUnitTest, xmutex);
UNITTEST_SUITE_DECLARE(cUnitTest, xsemaphore);
UNITTEST_SUITE_DECLARE(cUnitTest, cthread);
